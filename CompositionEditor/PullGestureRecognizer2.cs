...
namespace CompositionEditor;
    ...
    public class PullGestureRecognizer2 : GestureRecognizer
    {
        // internal static int MinPullDetectionSize = 50;
        internal static int MinPullDetectionSize = 0;
        ...
        public static readonly StyledProperty<PullDirection> PullDirectionProperty =
            AvaloniaProperty.Register<PullGestureRecognizer2, PullDirection>(nameof(PullDirection));
        ...
        public PullGestureRecognizer2(PullDirection pullDirection)
        {
            PullDirection = pullDirection;
        }

        public PullGestureRecognizer2() { }
        ...
        {
            if (Target != null && Target is Visual visual && (e.Pointer.Type == PointerType.Touch || e.Pointer.Type == PointerType.Pen || e.Pointer.Type == PointerType.Mouse))
